        ...
        <div class="modal-content">
            <div class="modal-body">
                <div class="p-3">
                    <h1>วัคซีน</h1>
                    <div class="content">
                        วัคซีนเป็นเครื่องมือทางสาธารณสุขที่มีความสำคัญในการป้องกันและควบคุมโรคสามารถลดการป่วย การตาย และความพิการของประชาชนได้จำนวนมาก
                    </div>
                    <div class="content">
                        ในอดีตที่ผ่านมา
                        ...
                        19 อย่างเพียงพอ จะนำไปสู่<span class="no-wrap">การควบคุม</span>การระบาดโรคโควิด 19 ได้อย่างมีประสิทธิภาพต่อไป
                    </div>
                    <div class="p-link">
        ...
        <div class="modal-content">
            <div class="modal-body">
                <div class="p-3">
                    ...
                    <div class="content">
                        ตั้งแต่อดีตจนถึงปัจจุบันประชาชนไทยยังต้องเผชิญกับสถานการณ์การระบาดของโรคที่ป้องกันได้ด้วยวัคซีน และโรคอุบัติใหม่/อุบัติซ้ำอย่างต่อเนื่อง ส่งผลให้เกิดการเจ็บป่วยและเสียชีวิตเป็นจำนวนมาก โดยเฉพาะอย่างยิ่งการระบาดของโรคโควิด 19 ที่นับเป็นการระบาดครั้งใหญ่ทั่วโลก
                    </div>
                    <div class="p-link">
            ...
            <div class="modal-body">
                <div class="p-3">
                    ...
                    <div class="content">ต่อมาได้มีการตรา
                        พ.ร.บ.ความมั่นคงด้านวัคซีนแห่งชาติ พ.ศ. 2561 ซึ่งได้กำหนดให้มีนโยบายและแผนยุทธศาสตร์ความมั่นคงด้านวัคซีนแห่งชาติ (ฉบับที่ 1 พ.ศ.
...
<div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="two__pointer__two"
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable"
        ...
        <div class="modal-content">
            <div class="modal-body">
                <div class="p-3">
                    <h1>Blueprint เพื่อการเข้าถึงวัคซีนป้องกันโควิด 19 ของประชาชนไทย</h1>
        ...
        <div class="modal-content">
            <div class="modal-body">
                <div class="p-3">
                    ...
                    <div class="content">
                        เพื่อขับเคลื่อนการพัฒนาวัคซีนและให้ประชาชนเข้าถึงวัคซีนที่มีประสิทธิภาพได้อย่างทั่วถึงและ<span class="no-wrap">ทันการณ์</span>
            ...
            <div class="modal-body">
                <div class="p-3">
                    ...
                    <div class="content">
                        ...
                        และ<span class="no-wrap">ความปลอดภัย</span>ในสัตว์ทดลองเป็นหลัก การทดสอบในสัตว์ทดลองระยะนี้
                    ...
                    <div class="text-center">
                        ...
                        <div class="book">
                            <a href="{{route('http::booth.research.detail',21)}}" target="_blank">
                                <img src="{{asset('images/exhibition/preclinical/logo-LAC-MU.png')}}" alt="" width="200px">
                            </a>
                        </div>
                    </div>
                    <div class="text-center mt-3">
...
<div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="four__pointer__pp"
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable"
        ...
        <div class="modal-content">
            <div class="modal-body">
                <div class="p-3">
                    <h1>Pilot production</h1>
                    <div class="content">
                        การพัฒนาวัคซีนที่ประสบผลสำเร็จในห้องปฏิบัติการ
                        และมีแนวโน้มที่ดีในการทดสอบในสัตว์ทดลอง
                        จะถูกนำมาวิจัยพัฒนาในขั้นตอนที่เรียกว่า การขยายขนาดการผลิต (Small scale process development) ในโรงงานต้นแบบ (Pilot plant) ที่ได้รับการรับรองมาตรฐานสากล
                    ...
                    <div class="content pb-3">
                        ...
                        มหาวิทยาลัยพระจอมเกล้าธนบุรี โรงงานต้นแบบขององค์การเภสัชกรรม และ บริษัท ไบโอเนท-เอเชีย จ้ากัด อย่างไรก็ตาม โรงงานต้นแบบ
                ...
                <div class="p-3">
                    ...
                    <ul>
                        <li>ระยะที่ 1
                            ...
                            เน้นศึกษาความปลอดภัยและความสามารถใน<span class="no-wrap">การกระตุ้น</span>ภูมิคุ้มกันของวัคซีน
                            โดยขั้นตอนนี้ใช้เวลาประมาณ 1 ปี
                        </li>

                        <li>ระยะที่ 2
                            ทดสอบในกลุ่มเสี่ยงที่อยู่ใกล้ชิดกับผู้ป่วยและมีความเสี่ยงต่อการติดเชื้อของโรคที่ทำ<span class="no-wrap">การวิจัย</span>
                    ...
                    <div class="text-center">
                        ...
                        <div class="book">
                            <a href="{{route('http::booth.production-network.detail',8)}}" target="_blank">
                                <img src="{{asset('images/exhibition/production/logo-GPO.png')}}" alt="" width="150px">
                            </a>
                        </div>
                        <div class="book">
                        ...
                        <div class="book">
                            <a href="{{route('http::booth.production-network.detail',1)}}" target="_blank">
                                <img src="{{asset('images/exhibition/production/logo-Bionet.png')}}" alt="" width="150px">
                            </a>
                        </div>
                        <div class="book">
                            <a href="{{route('http::booth.production-network.detail',5)}}" target="_blank">
                                <img src="{{asset('images/exhibition/production/logo-baiya.png')}}" alt="" width="150px">
                            </a>
                        </div>
                        <div class="book">
            ...
            <div class="modal-body">
                <div class="p-3">
                    ...
                    <div class="content">
                        ...
                        นอกจากการพัฒนาด้านโครงสร้าง<span class="no-wrap">พื้นฐาน</span>แล้ว
                        การพัฒนาบุคลากรจึงเป็นสิ่งสำคัญในการ<span class="no-wrap">ขับเคลื่อน</span>งานด้านวัคซีนให้ประสบผลสำเร็จตามเป้าหมาย
                    </div>
                    <div class="content pb-3">
            ...
            <div class="modal-body">
                <div class="p-3">
                    ...
                    <div class="content pb-3">
                        ...
                        และการนำไปใช้กับประชาชน ประกอบไปด้วยหน่วยงานรัฐและเอกชน องค์กรภาคีเครือข่ายทั้งในและต่างประเทศ กล่าวคือ
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <div class="p-3">
                    <h1>
                        การจัดลำดับการให้วัคซีน<br>
                        (Prioritizing Use of COVID-19 Vaccines)
                    </h1>
                    <div class="content">
                        เนื่องจากความต้องการใช้วัคซีนโควิด 19 มีสูงมากจากทั่วโลก ในขณะที่กำลังการผลิตวัคซีนมีจำกัดโดยเฉพาะใน
                        ช่วงแรกที่มีการพัฒนาวัคซีนสำเร็จ ดังนั้น เพื่อให้การใช้วัคซีนเกิดประโยชน์สูงสุดใน<span class="no-wrap">การป้องกัน</span>การสูญเสียชีวิต และสามารถประคองระบบสาธารณสุขให้สามารถดำเนินการต่อไปได้ จึงต้องมีการจัดลำดับความสำคัญของการได้รับวัคซีนของประชากรในกลุ่มต่าง ๆ ที่มีความรุนแรงของการเกิดโรคแตกต่างกัน
                        องค์การอนามัยโลก (WHO) ได้จัดลำดับความสำคัญของประชาชนกลุ่มที่ควรได้รับวัคซีน ตั้งแต่ช่วงแรกของการมีวัคซีนโควิด 19 และมีการปรับปรุงคำแนะนำเมื่อสถานการณ์<span class="no-wrap">มีการเปลี่ยนแปลง</span>และมีข้อมูลประกอบการพิจารณาเพิ่มเติม
                    </div>
                    <div class="p-link">
                        <a href="https://www.who.int/publications/i/item/who-sage-roadmap-for-prioritizing-uses-of-covid-19-vaccines" target="_blank" class="link-out">
                            <i class="fa fa-external-link icon-yellow"></i>
                        </a>
                    </div>
                    <div class="text-center">
                        <button type="button" data-bs-dismiss="modal" aria-label="Close" class="btn btn-primary btn__close">
                            ปิด <i class="fa fa-times" style="font-size: 19px; font-weight: 100;"></i>
                        </button>
                    </div>
                </div>
            </div>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <div class="p-3">
                    <h1>
                        การใช้วัคซีนสูตรไขว้ <br>
                        (Heterologous Vaccination)
                    </h1>
                    <div class="content">
                        ในภาวะที่วัคซีนขาดแคลนและไม่สามารถจัดหาวัคซีนชนิดเดียวกันได้เพียงพอ จึงต้องมี<span class="no-wrap">การพิจารณา</span>
                        การใช้วัคซีนแบบต่างชนิดหรือสูตรไขว้ รวมทั้งมีเหตุผลอื่นร่วมด้วย เช่น เพื่อลดอาการไม่พึงประสงค์ภายหลังการฉีดวัคซีน
                        และเพื่อการสร้างภูมิคุ้มกันที่สูงกว่าการใช้วัคซีนชนิดเดียวกัน
                        ปัจจุบันมีการใช้วัคซีนสูตรไขว้ในหลายประเทศ ซึ่งจะมีการพิจารณาอย่างรอบคอบ ทั้งจากวัคซีนที่จัดหาได้ <span class="no-wrap">การคาดการณ์</span>การจัดหาวัคซีนที่จะเกิดขึ้น
                        ความสามารถในการเข้าถึงวัคซีนควบคู่กับประโยชน์และ<span class="no-wrap">ความเสี่ยง</span>ที่อาจเกิดขึ้นจากผลิตภัณฑ์ที่ใช้
                        ซึ่งข้อมูลการศึกษาการใช้วัคซีนต่างชนิดที่หลายประเทศรวมถึงองค์การอนามัยโลกนำมาพิจารณา
                        เพื่อให้คำแนะนำการใช้วัคซีนสูตรไขว้ ประกอบด้วยข้อมูลการศึกษาประสิทธิผลของวัคซีน ข้อมูลการศึกษาการสร้างภูมิคุ้มกันที่เกิดขึ้นจากการฉีดวัคซีนต่างชนิด
                        และข้อมูลความปลอดภัยในการใช้วัคซีนที่มีอยู่ในปัจจุบัน
                        WHO ได้พิจารณากำหนดคำแนะนำสำหรับการใช้วัคซีนทั้งการฉีดวัคซีนสูตรไขว้ และการใช้วัคซีนต่างชนิดเป็น
                        วัคซีนเข็มกระตุ้น
                    </div>
                    <div class="p-link">
                        <a href="https://www.who.int/publications/i/item/WHO-2019-nCoV-vaccines-SAGE-recommendation-heterologous-schedules" target="_blank" class="link-out">
                            <i class="fa fa-external-link icon-yellow"></i>
                        </a>
                    </div>
                    <div class="text-center">
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <div class="p-3">
                    <h1>
                        การฉีดวัคซีนเข็มกระตุ้น (Booster Vaccine)
                    </h1>
                    <span class="no-wrap"></span>
                    <div class="content">
                        การระบาดของโรคโควิด 19 เกิดขึ้นอย่างต่อเนื่องและรุนแรง และพบว่าไวรัสโคโรนา 2019 มี<span class="no-wrap">การกลายพันธุ์</span>อย่างรวดเร็ว
                        ผลการศึกษาการใช้วัคซีนโควิด 19 จากทั่วโลกพบว่า
                        วัคซีนทุกชนิดสามารถป้องกันอาการป่วยที่รุนแรง ลดอัตราการเข้ารับการรักษาในโรงพยาบาล และลดอัตราการเสียชีวิตจากโควิด 19 ได้ แต่ไม่มีวัคซีนชนิดใดป้องกันการติดเชื้อได้ 100% และเมื่อฉีดวัคซีนไปแล้วระยะหนึ่งภูมิคุ้มกันจะลดลงตามธรรมชาติ ทำให้มีความจำเป็นที่ต้องมีการฉีดวัคซีนเข็มกระตุ้น เพื่อเพิ่มระดับภูมิคุ้มกันให้สูงมากพอที่จะรับมือกับไวรัสกลายพันธุ์ได้ สำหรับคำแนะนำในการฉีดวัคซีนเข็มกระตุ้นนั้น ใช้แนวทางการพิจารณาเช่นเดียวกับการฉีดวัคซีนสูตรไขว้
                    </div>
                    <div class="text-center mt-3">
                        <button type="button" class="btn btn-primary btn__close" data-bs-dismiss="modal" aria-label="Close">ปิด <i class="fa fa-times" style="font-size: 19px; font-weight: 100;"></i>
                        </button>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <div class="p-3">
                    <h1>
                        การฉีดวัคซีนเข็มเสริมสำหรับผู้มีภูมิคุ้มกันต่ำ <br>
                        (Additional doses)
                    </h1>
                    ...
                    <div class="p-link">
                        <a href="https://www.who.int/publications/i/item/WHO-2019-nCoV-vaccines-SAGE_recommendation-immunocompromised-persons" target="_blank" class="link-out">
                            <i class="fa fa-external-link icon-yellow"></i>
                        </a>
                    </div>
                    <div class="text-center">
...
<div class="modal fade" tabindex="-1" role="dialog"  aria-labelledby="five__pointer__green" id="five__pointer__green">
    <div class="modal-dialog modal-lg  modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <div class="p-3">
                    <h1>การสื่อสารระยะที่ 1 - ก่อนมีวัคซีน</h1>
                    <div class="title_no_weight pb-3 mt-3">
                    ...
                    <div class="text-center pt-4 d-sm-block d-lg-flex justify-content-center align-items-end">
                        <div class="book">
                            <a href="https://www.thaihealth.or.th/Books/714/%E0%B8%84%E0%B8%B9%E0%B9%88%E0%B8%A1%E0%B8%B7%E0%B8%AD+%E0%B8%A7%E0%B8%B1%E0%B8%84%E0%B8%8B%E0%B8%B5%E0%B8%99%E0%B8%AA%E0%B8%B9%E0%B9%89%E0%B9%82%E0%B8%84%E0%B8%A7%E0%B8%B4%E0%B8%94+(%E0%B8%89%E0%B8%9A%E0%B8%B1%E0%B8%9A%E0%B8%9B%E0%B8%A3%E0%B8%B0%E0%B8%8A%E0%B8%B2%E0%B8%8A%E0%B8%99).html" target="_blank" class="link-out-small">
                                <img src="{{asset('images/exhibition/page5_button_red.png')}}" class="img-fluid"><br>
                                คู่มือวัคซีนสู้โควิด ฉบับประชาชน
                            </a>
                        </div>
                        <div class="book">
                            <a href="https://www.facebook.com/154755461366324/photos/pb.100066819803786.-2207520000../1841059292735924/?type=3" target="_blank" class="link-out-small">
                                <img src="{{asset('images/exhibition/page5_button_red2.png')}}" class="img-th" width="125px"><br>
                                อัปเดตความก้าวหน้าของวัคซีนในต่างประเทศ
                            </a>
                        </div>
                    </div>

                    <div class="p-link">
                        <a href="https://fb.watch/bagv_63Vi_" target="_blank" class="link-out">
                            <small>
                                เสวนา THAILAND COVID-19 VACCINE FORUM 2021 <br>
                                สถานการณ์ความก้าวหน้าการพัฒนาวัคซีนไทยสู้โควิดโดยทีมประเทศไทย
                            </small> <i class="fa fa-external-link icon-yellow"></i>
                        </a>
                        <br>
                        <a href="https://www.youtube.com/watch?v=IrxAk_PeJ4Y" target="_blank" class="link-out">
                            <small>คลิป 2D motion เรื่อง “ความปลอดภัยของการใช้วัคซีนโควิด 19”</small>
                            <i class="fa fa-external-link icon-yellow"></i>
                        </a>
                    </div>
            ...
            <div class="modal-body">
                <div class="p-3">
                    ...
                    <ul class="content_no_indent mt-3">
                        ...
                        <li>ให้ข้อมูลการระบาดของไวรัสสายพันธุ์ใหม่</li>
                        <li>
                    ...
                    <div class="p-link">
                        ...
                        <a href="https://fb.watch/baf1UHHjD7/" target="_blank" class="link-out">
                            <small>
                                เสวนาออนไลน์ “เปิดข้อมูล (ไม่) ลับ กับสถาบันวัคซีนแห่งชาติ”
                        ...
                        <a href="https://fb.watch/baeY4o9L8J/" target="_blank" class="link-out">
                            <small>
                                ...
                                “รับมืออย่างไรเมื่อไวรัสสายพันธุ์ใหม่มาเยือน”
                            </small>
                            <i class="fa fa-external-link icon-yellow"></i>
                        </a>
                        <br>
                        <a href="https://fb.watch/baeSFtRFpE/" target="_blank" class="link-out">
                            <small>
                                ...
                                ฉีดในเด็ก 5-11 ปี: เรื่องที่พ่อ-แม่ต้องรู้”
                            </small>
                            <i class="fa fa-external-link icon-yellow"></i>
                        </a>
                    </div>
            ...
            <div class="modal-body">
                <div class="p-3">
                    ...
                    <div class="content">
                        ...
                        กระทรวงสาธารณสุข ได้กำหนดให้มีการให้บริการวัคซีนพื้นฐานกับประชาชน เรียกว่า แผนงานสร้างเสริมภูมิคุ้มกันโรค
                        (Expanded Program on Immunization, EPI) โดยเริ่มดำเนินการตั้งแต่ปี พ.ศ. 2520 มีเป้าหมายเพื่อลดอัตราป่วยและอัตราตายของโรคติดต่อที่ป้องกันได้ด้วยวัคซีน
                        ...
                        ทั้งวัคซีนสำหรับเด็กและผู้ใหญ่ ซึ่งประชาชนกลุ่มเป้าหมายจะได้รับบริการโดยไม่คิดมูลค่า
                        ทั้งนี้ ในสถานการณ์ที่มีการระบาดใหญ่ของ<span class="no-wrap">โรคอุบัติใหม่</span> องค์การอนามัยโลก (WHO) จะมีการกำหนดนโยบายการใช้วัคซีน
                        เพื่อเป็นคำแนะนำให้แก่ประเทศต่าง ๆ ในการกำหนดนโยบายการใช้วัคซีนเพื่อการตอบโต้โรคอุบัติใหม่ที่เหมาะสมกับบริบทของแต่ละประเทศ
                        สำหรับประเทศไทยได้มีการกำหนดนโยบาย/แนวทางการให้วัคซีนโควิด 19 โดยกระทรวงสาธารณสุข ประเทศไทยพิจารณาดำเนินการภายใต้
                    </div>
                    <ol class="content_no_indent mt-3">
                        <li>คำแนะนำของคณะอนุกรรมการสร้างเสริม
                            ภูมิคุ้มกันโรค (ภายใต้คณะกรรมการวัคซีนแห่งชาติ) ซึ่งอาศัยข้อมูลวิชาการที่มีในขณะนั้น ร่วมกับนโยบาย/แนวทางให้วัคซีนในระดับนานาชาติ
                        ...
                        <li>
                            เงื่อนไขในการบริหารจัดการวัคซีนให้มีประสิทธิภาพสูงสุด
                        </li>
                    </ol>
                    <div class="text-center">
...
<div class="modal fade" tabindex="-1" aria-labelledby="five__pointer__center" id="five__pointer__center" aria-modal="true" role="dialog">
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <div class="p-3">
                    ...
                    <div class="content pb-3">
                        ...
                        ทั้งภาครัฐและภาคเอกชนในการเผยแพร่ข้อมูลข่าวสารด้านวัคซีนที่ถูกต้อง
                        และรวดเร็ว
                        เพื่อสร้าง<span class="no-wrap">ความเข้าใจ</span>ที่ถูกต้องเหมาะสมต่อกลุ่มเป้าหมายต่างๆ
                        ได้แก่ ประชาชน ผู้ตัดสินเชิงนโยบาย
                        และหน่วยงาน<span class="no-wrap">เครือข่าย</span> ซึ่งดำเนินการในเชิงรุก
                        ...
                        ๆ รวมถึง<span class="no-wrap">การป้องกัน</span> ตอบโต้ (Response)
